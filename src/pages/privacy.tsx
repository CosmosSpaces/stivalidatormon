    ...
    <Main normalHeader>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="pt-8 pb-0">
          <h1 className="text-2xl font-bold leading-7 text-cyan-400 sm:text-3xl mb-10">
            {' '}
            Privacy Policy{' '}
          </h1>
        </header>
        ...
        <section className="pb-8 text-white text-sm">
          ...
          <p className="mb-2">
            ...
            Mainly because we don&apos;t collect any and also we&apos;re not
            evil. Regardless, we have no data to sell so this is not a concern
            for our users.
          </p>
          ...
          <p className="mb-2">
            ...
            servers (though we don&apos;t even have a server so this isn&apos;t
            a problem). If you are a parent or guardian and you are aware that
